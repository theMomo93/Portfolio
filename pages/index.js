...
export default function Home() {
  ...
  <div className="flex-1 flex flex-col justify-center items-start m-6 lg:m-12 p-4 text-center lg:text-left">
    ...
    <p className="text-lg sm:text-xl lg:text-2xl mb-6 lg:mb-8">
      ...
      experience. I know how to center a div. I invite you to explore more about me and my skills.
    </p>
  ...
  <div className="flex-1 flex justify-center items-center m-4 lg:m-12">
    <Image className="rounded shadow-2xl" src={myImage} width={600} height={500} alt="picture of a web developer"/>
  </div>
</section>

      <section className="bg-gray-50 min-h-screen flex flex-col justify-start items-center py-8 sm:py-16 outline outline-offset-1 outline-4">
  <h1 className="text-4xl sm:text-5xl lg:text-7xl font-medium leading-normal mb-6 lg:mb-12">
    Welcome to my Skills Zone
  </h1>

  <div className="flex flex-col sm:flex-row flex-1 w-full max-w-screen-lg">
    <div className="flex flex-col justify-center sm:mx-12 my-4 sm:my-0 w-full p-4 hero-bg rounded shadow-2xl">
      <h2 className="text-3xl sm:text-4xl tracking-widest underline mb-4 text-center font-semibold ">Technical Skills</h2>
    ...
    <div className="flex flex-col justify-center sm:mx-12 my-4 sm:my-0 ml-8 p-8 hero-bg rounded shadow-2xl">
      <h2 className="text-3xl sm:text-4xl tracking-widest underline mb-4 text-center font-semibold">Soft Skills</h2>
...
<h1 className="text-4xl sm:text-5xl lg:text-7xl font-medium leading-normal mb-6 lg:mb-12"> My Projects</h1>

<p className="text-lg sm:text-xl lg:text-2xl mb-6 lg:mb-8">
During my Bootcamp we had hands-on experiences and created many interesting Projects. </p>
</div>
